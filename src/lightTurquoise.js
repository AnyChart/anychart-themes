const stockScrollerUnselected = '#999 0.6';
 ...
 * @return {*}
 */
const returnSourceColor50 = function() {
  return window['anychart']['color']['setOpacity'](this['sourceColor'], 0.5, true);
};
 ...
 * @return {*}
 */
const returnDarkenSourceColor = function() {
 ...
 * @return {*}
 */
const returnLightenSourceColor = function() {
  return window['anychart']['color']['lighten'](this['sourceColor']);
};


const lightTurquoise = {
  'palette': {
    'type': 'distinct',
...
window['anychart']['themes']['lightTurquoise'] = lightTurquoise;

export default lightTurquoise;
